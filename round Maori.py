...
while round < rounds_playing:
 ...
 # 1st list
    ...
    question = random.choice(days_of_the_week_Maori)
    print(question)
    # Using the index position of the question in one list to find the corresponding
    # Index position of the answer

    answer_index = days_of_the_week_Maori.index(question)
    answer = days_of_the_week[answer_index]

    # Compare the attempt to see if it matches the correct answer
    attempt = input(f" what is {question} in English or numbers: ")
